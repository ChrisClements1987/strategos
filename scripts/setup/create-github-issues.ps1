...
# Run this from the project root: powershell scripts/setup/create-github-issues.ps1

Write-Host "Creating v0.1 GitHub issues..." -ForegroundColor Green
...
gh issue create --title "Portfolio Management (CRUD)" `
  ...
  --label "v0.1" --label "theme:core-engine" --label "epic:E-1.1" --label "type:feature"
...
gh issue create --title "Dynamic Phase (Roadmap) View" `
  ...
  --label "v0.1" --label "theme:dynamic-views" --label "epic:E-2.1" --label "type:feature"
...
gh issue create --title "Tauri Cross-Platform Build" `
  ...
  --label "v0.1" --label "theme:app-shell" --label "epic:E-5.1" --label "type:feature"
...
gh issue create --title "Documentation (README, User Guides)" `
  ...
  --label "v0.1" --label "theme:app-shell" --label "epic:E-5.2" --label "type:docs"

Write-Host "`n✅ All v0.1 issues created successfully!" -ForegroundColor Green
